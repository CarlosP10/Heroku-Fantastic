...
@Controller
public class SaveNewOfferController extends SessionMethods {
	...
	public ModelAndView SaveOfferRedirection(HttpSession session, @RequestParam String offername,
			@RequestParam String description, @RequestParam String urlposter, @RequestParam int availability,
			@RequestParam String startdate, @RequestParam String enddate, @RequestParam String offer_code,
			@RequestParam int offer_state, @RequestParam float price_range, @RequestParam int type) {
